...
const CartDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    return (
        <DataTable value={items} onRowClick={onRowClick} scrollable rowHover paginator rows={10}>
            <Column field="product" header="Product" body={pTemplate0} sortable style={{ minWidth: "8rem" }} />
            <Column field="quantity" header="Quantity" body={pTemplate1} sortable style={{ minWidth: "8rem" }} />
