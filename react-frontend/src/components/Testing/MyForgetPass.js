...
const ForgetPasswordPage = (props) => {
    ...
    const onEnter = (e) => {
        if (e.key === "Enter") submit_password();
    };
            ...
            <div className="col-12 lg:col-5 px-6">
                <div className="card">
                    ...
                    <div className="flex flex-column align-items-center ">
                        ...
                        <p className="text-center">Please enter your name, email and new password, if the name and email are correct, will update your account password with the latest.</p>
                    ...
                    <div className="flex justify-content-center mt-3">
                        <div className="col-6 lg:col-6">
                            <Button label="Change Now" className="p-button-raised p-button-rounded" onClick={submit_password}></Button>
                        </div>
                    </div>
                </div>
            </div>
